...
//var size_arr = [500e3, 950715, 1500e3, 5806015, 8000e3, 39557045, 50000e3, 146877088, 200000e3];
//var names_arr = ["Sandhill Cranes", "Austin, Texas", "Wildebeest", "Denmark", "Straw-Colored Fruit Bats",
//"California", "Red Crab of Christmas Island", "Russia", "Monarch Butterfly"];
              ...
              '</div>'+
                '<div class="row">'+
                  '<div class="col-lg-5 col-md-5 col-sm-5 col-5">'+
                      '<img class="animal_thumbnail" src="data/img/distance_img'+name_idx+'.jpg"></img>'+
                  '</div>'+
                  '<div class="col-lg-7 col-md-7 col-sm-7 col-7 animal_description">'+
          ...
          if (name_idx%2 === 0) {
            ...
            return tooltip.html(
              ...
              '</div>'+
                '<div class="row">'+
                  '<div class="col-lg-5 col-md-5 col-sm-5 col-5">'+
                      '<img class="animal_thumbnail" src="data/img/img'+name_idx+'.jpg"></img>'+
                  '</div>'+
                  '<div class="col-lg-7 col-md-7 col-sm-7 col-7 animal_description">'+
