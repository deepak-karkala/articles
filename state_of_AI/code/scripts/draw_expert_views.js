  	...
  	d3.csv(file, function(error, data) {
		...
		svg.selectAll(".dot")
	      ...
	      .enter().append("circle")
	        ...
	        .style("fill", function(d) { return colorScale(d.dangerous*0.75/10); })
	        .style("stroke", "white")
	          	...
	          	'<div class="row flex-container">' +
	          		'<div class="col-lg-12">' +
			          	'<div class="row mx-auto text-center">' +
			          		...
			          		'<div class="col-lg-8">' + 
			          			'<div class="row">' +
			          				'<div class="col-lg-12 profile_name">' + d.name +
			          				'</div>' +
			          			'</div>' +
			          			'<div class="row">' +
			          				'<div class="col-lg-12 profile_position">' + d.position +
			          				'</div>' +
			          			'</div>' +
			          		'</div>' +
			          	'</div>' +
			          	...
			          	'<div class="row profile_source">' +
			          		'<div class="col-lg-4">' + d.date +
			          		'</div>' +
			          		'<div class="col-lg-8"><a href="'+ d.link +'">' + d.media + '</a>' +
			          		'</div>' +
			          	'</div>' +
			        '</div>' +
			    '</div>'
...
*/
		svg.selectAll(".text")
	        .data(data)
	      .enter().append("text")
	        .attr("x", function(d) { return x(d.dangerous+0.25); })
